...
PLAYER_MAX_HORIZONATAL_SPEED = 200
...
class GameWindow(arcade.Window):
    ...
    def setup(self):
        ...
        gravity = (0,-GRAVITY)
        self.physics_engine = arcade.PymunkPhysicsEngine(gravity=gravity,damping=DEFAULT_DAMPING)
        ...
        self.physics_engine.add_sprite(self.player_sprite,
                                       ...
                                       max_horizontal_velocity=PLAYER_MAX_HORIZONATAL_SPEED,
